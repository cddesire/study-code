...
public class HCatMultipleInputs {
     ...
     */
    public static void addInput(Job job, String dbName, String table, String filter, Class<? extends Mapper> mapperClass) {
    ...
    static InputInfo readInputInfoFromSplit(HCatSplit split) {
        String inputInfoString = split.getPartitionInfo().getInputStorageHandlerProperties()
                .getProperty(HCatMultipleInputs.CONF_INPUTINFO);
